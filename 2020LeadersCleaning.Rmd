...
foundFile <- checkForFile(existingLeadersFile, c(localDataDir, ODataDir), crash = FALSE)
...
foundFile <- checkForFile(newLeadersFile, c(localDataDir, ODataDir), crash = FALSE)
